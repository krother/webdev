...
- [ ] the page has a HTML header
- [ ] the page has a navigation menu with internal or on-page links
- [ ] the page uses CSS and/or bootstrap classes
- [ ] the page contains images
- [ ] the page contains a contact form
- [ ] the code is available on GitHub
- [ ] the page correctly references image sources
- [ ] the page uses a consistent color pallette
